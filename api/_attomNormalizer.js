/**
 * CJS copy of src/utils/attomSnapshotNormalizer.js for server-side use.
...
const getFirstProperty = (payload) => {
  ...
  const a = Array.isArray(list) ? list : list != null ? [list] : [];
  return a[0] ?? null;
};
 ...
 */
function normalizeAttomSnapshot(apiResponse) {
...
module.exports = { normalizeAttomSnapshot };
