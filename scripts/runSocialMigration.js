/**
 * Run 001_social_schema.sql on Neon. Uses DATABASE_URL from env or .env in project root.
 * Run from project root: node scripts/runSocialMigration.js
 */
...
const sqlPath = path.join(__dirname, 'migrations', '001_social_schema.sql');
...
async function run() {
  ...
  try {
    ...
    console.log('Migration 001_social_schema.sql completed.');
  } catch (err) {
